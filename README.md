...
Ana Rita | Galaxiay11 | Product Owner, Desenvolvimento da interface, design gráfico, agente reativo, documentação e líder do grupo|

José Oliveira | Wodash34 | Desenvolvimento do frontend, backend, API, design gráfico, área de administrador, defesas e precausões, base de dados|

Tiago Carvalho | Tiago0612 | API, base de dados, defesas e precausões, área de administrador, arquitetura, correções de bugs|

Vanina Kollen | vankol06 | Estruturação da base de dados, design gráfico, correções de bugs, relatório técnico|

Francisco Ribeiro | Xico20230 | Criação de diagramas das funcionalisades|
